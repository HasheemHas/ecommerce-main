        ...
        <div class="form-group">
                  ...
                  <div class="form-group">
                   ...
                   <div class="form-group">
                    <div class="col-md-8">
                      <label class="col-md-4 control-label" for=
                      "PROSTATS">Status:</label>

                      <div class="col-md-8">
                       <select class="form-control input-sm" name="PROSTATS" id="PROSTATS">
                           <option value="Available" <?php echo ($singleproduct->PROSTATS == 'Available') ? 'selected' : ''; ?>>Active</option>
                           <option value="NotAvailable" <?php echo ($singleproduct->PROSTATS == 'NotAvailable') ? 'selected' : ''; ?>>Draft</option>
                           <option value="Archived" <?php echo ($singleproduct->PROSTATS == 'Archived') ? 'selected' : ''; ?>>Archived</option>
                        </select> 
                      </div>
                    </div>
                  </div>

       ...
       <div class="row">
		  	<div class="col-md-6 pull-left">
		  	 <div>Ordered Date : <?php echo date_format(date_create($cur->ORDEREDDATE),"M/d/Y h:i:s"); ?></div> 
		  		...
		  		<div>Payment Remarks / UTR : <strong style="color: #2563eb;"><?php echo $cur->ORDEREDREMARKS; ?></strong></div>

		  	</div>
		  	<div class="col-md-6 pull-right">
		  		<p align="right">Total Price : ₹ <?php echo number_format($subtot,2);?></p>
		  		<p align="right">Delivery Fee : ₹ <?php echo number_format($cur->DELFEE,2); ?></p>

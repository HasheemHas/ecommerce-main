...
<form class="form-horizontal span6" action="controller.php?action=edit" method="POST" enctype="multipart/form-data"    >
 <div style="margin-bottom: 20px; border-bottom: 1px solid #f1f5f9; padding-bottom: 15px;">
    <h3 style="margin:0; font-weight:700; color:#0f172a; font-size:16px;"><i class="fa fa-truck" style="margin-right:8px; color:#1e3a8a;"></i>Edit Location & Delivery Fee</h3>
 </div> 
 ...
 <div style="margin-bottom: 20px; border-bottom: 1px solid #f1f5f9; padding-bottom: 15px;">
    <h3 style="margin:0; font-weight:700; color:#0f172a; font-size:16px;"><i class="fa fa-plus-circle" style="margin-right:8px; color:#1e3a8a;"></i>Add New Location & Delivery Fee</h3>
 </div> 

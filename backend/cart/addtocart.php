         ...
         <tbody > 
            ...
            ?>
                      <tr>
                        ...
                        <!-- end -->
                        <td>   <a href="../backend/cart/controller.php?action=delete&id=<?php echo $result->PRODUCTID; ?>"  data-id="<?php echo $result->PRODUCTID ?>"   class="delete btn btn-danger btn-xs">Remove</a></td> 
                      </tr>
            <?php
              }
                    ...
                    <div class="col-md-10">
                      ...
                      <div class="col-md-8">
                         <input class="form-control input-sm" id="FIRSTNAME" name="FIRSTNAME" placeholder=
                            "First Name" type="text" value="" autocomplete="off">
                      </div>
                    </div>
                  </div>
                        ...
                        <div class="col-md-10">
                          ...
                          <div class="col-md-8">
                             <input class="form-control input-sm" id="HOMENUMBER" name="HOMENUMBER" placeholder=
                                "Home Number" type="text" value="" autocomplete="off">
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="col-md-10">
                          ...
                          <div class="col-md-8">
                             <input class="form-control input-sm" id="STREET" name="STREET" placeholder=
                                "Street" type="text" value="" autocomplete="off">
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="col-md-10">
                          ...
                          <div class="col-md-8">
                             <input class="form-control input-sm" id="BARANGGY" name="BARANGGY" placeholder=
                                "Barangay" type="text" value="" autocomplete="off">
                          </div>
                        </div>
                      </div>
                       <div class="form-group">
                        <div class="col-md-10">
                          ...
                          <div class="col-md-8">
                             <input class="form-control input-sm" id="CITYADDRESS" name="CITYADDRESS" placeholder=
                                "City Address" type="text" value="" autocomplete="off">
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="col-md-10">
                      ...
                      <div class="col-md-8">
                         <input class="form-control input-sm" id="PASS" name="PASS" placeholder=
                            "Password" type="password" value="" autocomplete="new-password"><span></span>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="col-md-10">
                      ...
                      <div class="col-md-8">
                         <input class="form-control input-sm" id="CONTACTNUMBER" name="CONTACTNUMBER" placeholder=
                            "Contact Number" type="text" value="" autocomplete="off">
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="col-md-10">
                      ...
                      <div class="col-md-8">
                         <input class="form-control input-sm" id="ZIPCODE" name="ZIPCODE" placeholder=
                            "Zip Code" type="number" value="" autocomplete="off">
                      </div>
                    </div>
                  </div>

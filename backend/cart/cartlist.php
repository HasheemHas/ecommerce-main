                         ...
                         <body onload=" totalprice(); ">
                            <tr> 
                             ...
                             <?php
                              ...
                              <form id="form" action="../backend/cart/controller.php?action=edit" method="POST"  
                                  ...
                                  <div class="column4">                                  
                                    ...
                                    <div class="form-inline" style="float: left; width:190px">  
                                        ...
                                        <!-- END -->
                                        <a href="../backend/cart/controller.php?action=delete&id=<?php echo $result->PRODUCTID; ?>" class="btn btn-link"   >Remove</a> 

...
-- 1. Vendors Seed
INSERT INTO `vendors` (`vendor_id`, `vendor_name`, `email`, `phone`, `address`, `rating`, `status`) VALUES
...
INSERT INTO `vendor_products` (`vendor_id`, `product_id`, `cost_price`, `lead_time_days`) VALUES
(2, 201737, 80.00, 5),
(2, 201738, 120.00, 6),
(2, 201739, 180.00, 4),
(2, 201740, 70.00, 5),
...
INSERT INTO `purchase_orders` (`po_id`, `po_number`, `vendor_id`, `status`, `total_amount`, `expected_delivery`, `created_at`) VALUES
...
INSERT INTO `vendor_payouts` (`vendor_id`, `po_id`, `amount`, `status`, `processed_at`) VALUES
(2, 1, 4850.00, 'Unpaid', NULL);

-- 5. Returns & Refunds Seed
INSERT INTO `returns` (`return_id`, `customer_id`, `order_number`, `return_status`, `request_date`, `reason_summary`, `refund_amount`) VALUES
...
INSERT INTO `return_items` (`return_id`, `product_id`, `quantity`, `return_reason_code`) VALUES
(1, 201737, 1, 'wrong_item'),
(2, 201738, 1, 'damaged');

INSERT INTO `refunds` (`return_id`, `transaction_reference`, `refund_method`, `refund_status`, `processed_at`) VALUES
(2, 'REF-2019-0822-948', 'Cash on Delivery', 'Success', DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 9 DAY));

-- 6. Coupons Seed
INSERT INTO `coupons` (`coupon_id`, `coupon_code`, `type`, `value`, `start_date`, `expiry_date`, `usage_limit`, `times_used`, `status`, `min_spend`, `max_spend`, `target_segment`) VALUES
...
INSERT INTO `coupon_usage` (`coupon_id`, `customer_id`, `order_number`, `discount_applied`) VALUES
(1, 9, 94, 19.90);

-- 7. Shipping Tracking Seed
INSERT INTO `shipping_tracking` (`tracking_id`, `order_number`, `carrier`, `tracking_number`, `status`, `origin_lat`, `origin_lng`, `current_lat`, `current_lng`, `dest_lat`, `dest_lng`, `eta_delivery`, `actual_delivery`) VALUES
...
INSERT INTO `shipping_updates` (`tracking_id`, `location`, `status_details`, `updated_at`) VALUES
...
INSERT INTO `low_stock_alerts` (`product_id`, `threshold`, `current_stock`, `status`, `notified_at`) VALUES
...
INSERT INTO `demand_forecasts` (`product_id`, `forecast_date`, `predicted_demand`, `recommended_reorder_qty`, `accuracy_metric`) VALUES
...
INSERT INTO `churn_scores` (`customer_id`, `churn_probability`, `risk_level`, `top_risk_factors`) VALUES
(1, 14.5, 'Low', '[]'),
...
INSERT INTO `product_reviews_sentiment` (`review_id`, `product_id`, `customer_id`, `review_text`, `rating`, `sentiment_label`, `sentiment_score`, `topics_extracted`, `is_fake`, `is_fake_confidence`) VALUES
...
INSERT INTO `recommendations` (`customer_id`, `product_id`, `recommendation_type`, `score`) VALUES
(9, 201739, 'ALS', 0.89),

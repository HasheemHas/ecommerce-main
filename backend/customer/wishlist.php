<h3>Wish List</h3>  
             <form   method="POST" action="<?php echo web_root ; ?>../backend/cart/controller.php?action=add">           
                    ...
                    <tbody>
                       ...
                       <button  type="submit"  class="btn btn-primary btn-sm"  name="btnorder">Order Now!</button>
                         <a href="<?php echo web_root ; ?>../backend/customer/controller.php?action=wishlist&wishid=<?php echo $result->WISHID; ?>"    class="btn btn-info btn-sm "  data-toggle="lightbox"  >
